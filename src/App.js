...
import LandingSignup from './Attendance/screens/LandingSignup';
import Home from './Attendance/screens/home';
...
const Routing = ()=>{
  ...
  useEffect(() => {
    ...
    if (!user) {
      history.push('/'); // Redirect to Signup page when no user is present
    }
  }, []);
  return(
    <Switch>
      ...
      <Route exact path="/landingSignup" >
      <LandingSignup />
      </Route>
