           ...
           <div style={{height:"400px",margin:"auto",backgroundColor:"white",width:"60%",opacity:"0.9",paddingTop:"50px"}}>
            ...
            <div className=" m-auto" style={{display:"flex",width:"100%",height:"300px",justifyContent:"center" }}>
                ...
                <div className="card" style={{marginLeft:"30px"}}>
                   ...
                   <Link className="link_class" to="/signup" style={{textDecoration:"none",fontFamily:"Oswald",color:"black",textAlign:"center"}}> <h3 >Signin as  Student</h3></Link>  
                </div>
                
                <div className="card" style={{marginLeft:"30px"}}>
                   <img src={TeacherImage} alt="StudentIMage" style={{height:"250px",width:"250px"}} />
                  
                   <Link className="link_class" to="/Tsignup" style={{textDecoration:"none",fontFamily:"Oswald",color:"black",textAlign:"center"}}> <h3 >Signin as  Teacher</h3></Link>  
                </div>
            </div>
            </div>
