...
export const getStudentByClass = (clsName)=> async dispatch =>{
    ...
    try {
        ...
        const response = await axios.post('http://13.53.205.28:5000/getStuByClass',clsName);
...
export const makeStuAttendance = (clsName,obj)=> async dispatch =>{
    ...
    try {
        ...
        const response = await axios.post('http://13.53.205.28:5000/makeAttdence',obj,config);

        console.log("response",response);
      
         const response1 = await axios.post('http://13.53.205.28:5000/getStuByClass',clsName);
...
export const uploadStuMark = (clsName,obj)=> async dispatch =>{
    ...
    try {
        ...
        const response = await axios.post('http://13.53.205.28:5000/uploadMark',obj,config);
...
export const getAllStudent = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('http://13.53.205.28:5000/getAllStuClass');
...
export const getAllRportAction = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('http://13.53.205.28:5000/allreport');
...
export const addReportAction = (user) => async dispatch => {
    ...
    try {
        const res = await axios.post("http://13.53.205.28:5000/addreport", user);
...
export const updateTProfileAction = (user) => async dispatch => {
    ...
    try {
        const res = await axios.post("http://13.53.205.28:5000/api/teac/teaUpd", user);
...
export const updateProfileAction = (user) => async dispatch => {
    ...
    try {
        const res = await axios.post("http://13.53.205.28:5000/stuUpd", user);
