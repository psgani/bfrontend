...
export const getAllNoticeAction = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('http://13.53.205.28:5000/allnotice');
...
export const addNoticeAction = (user) => async dispatch => {
    ...
    try {
        const res = await axios.post("http://13.53.205.28:5000/addnotice", user);
...
export const getAllClubAction = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('http://13.53.205.28:5000/allclub');
...
export const getClubJoinIssAction = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('http://13.53.205.28:5000/allissue');
...
export const addClubAction = (user) => async dispatch => {
    ...
    try {
        const res = await axios.post("http://13.53.205.28:5000/addclub", user);
...
export const addSubjectAction = (user) => async dispatch => {
    ...
    try {
        const res = await axios.post("http://13.53.205.28:5000/addSub", user);
...
export const getAllSubAction = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('http://13.53.205.28:5000/allSub');
        console.log("reas",response)
        dispatch({
...
export const acJoinRq = (id) => async dispatch => {
    console.log(id)
    try {
        const res = await axios.post('http://13.53.205.28:5000/acjoinclub',{id});
        const response = await axios.get('http://13.53.205.28:5000/allissue');
...
export const reqToJoinClubAction = (user) => async dispatch => {
    ...
    console.log(user)
    try {
        const res = await axios.post("http://13.53.205.28:5000/joinclub", user);
...
export const AcReqToJoinClubAction = (user) => async dispatch => {
    ...
    try {
        const res = await axios.post("http://13.53.205.28:5000/acjoinclub", user);
...
export const getAllFaculty = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('http://13.53.205.28:5000/getAllFac');
        console.log("reas",response)
        dispatch({
